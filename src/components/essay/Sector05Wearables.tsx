...
export default function Sector05Wearables() {
  ...
  return (
    <div>
      ...
      <section className="mac-desktop desktop-wearables py-24 px-4">
      ...
      {/* ===== INTRO WINDOW (Mode 1) ===== */}
      <section className="mac-desktop desktop-wearables py-16 px-4">
      ...
      {/* ===== MAC DIALOG BOX ===== */}
      {!dialogDismissed &&
      <section className="mac-desktop desktop-wearables py-8 px-4">
